    ...
    private void action(){
        real_estate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(user_dashboard.this,real_estate.class);
        ...
        agriculture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(user_dashboard.this,Agriculture.class);
                user_dashboard.this.startActivity(intent);
            }
        });
        ...
        IT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(user_dashboard.this,IT.class);
                user_dashboard.this.startActivity(intent);
            }
        });
        new_startup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(user_dashboard.this,Enterpreneur.class);
                user_dashboard.this.startActivity(intent);
            }
        });
